...
public class DoctorSignIn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Common.isConnectedToInternet(DoctorSignIn.this)) {
            // When Click On Scan Btn.
            ScanQRCodeBtn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(DoctorSignIn.this, QRCodeActivity.class);
            ...
            LogIn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    String type = "login_doc";

                    @SuppressLint("StaticFieldLeak")
                    BackgroundWorker backgroundWorker = new BackgroundWorker(DoctorSignIn.this) {
...
//                      Toast.makeText(context, "" + result, Toast.LENGTH_LONG).show();
                            ...
                            if (result.contains("exist")) {
                                Intent intent = new Intent(DoctorSignIn.this, DoctorHome.class);
...
//                                 intent.putExtra("password", password);
                                ...
                                Toast.makeText(DoctorSignIn.this, "Please enter valid userName/NewPassword!",
            ...
            // If Not Available.
            Toast.makeText(DoctorSignIn.this, "Please check your connection..!!", Toast.LENGTH_SHORT).show();
    }
}
